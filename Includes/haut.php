...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
    ...
    ?>
        ...
        <linl rel="stylesheet" title="Design" href="<?php echo ROOTPATH; ?>/design.css" type="text/css" media="screen" />
    </head>
    ...
    <body>
        ...
        <div id="menu">
            <div id="menu_gauche">
            <!-- Vide, mettez-y les liens qui ne dépendant pas du statut du membre (connecté ou non) -->
            </div>
